...
struct WorktreeVocabularyTests {
  ...
  @Test func gitVocabularyReproducesExistingStrings() {
    ...
    #expect(vocab.pin(isPinned: false) == "Pin Worktree")
    #expect(vocab.pin(isPinned: true) == "Unpin Worktree")
    ...
    #expect(vocab.newWorktreeTitle == "New Worktree")
  ...
  @Test func jujutsuVocabularyUsesWorkspaceAndBookmark() {
    ...
    #expect(vocab.pin(isPinned: false) == "Pin Workspace")
    #expect(vocab.pin(isPinned: true) == "Unpin Workspace")
